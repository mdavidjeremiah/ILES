...
export function CompaniesPage({ companies, supervisors, search }) {
  const filtered = companies.filter((company) =>
    [company.name, company.industry, company.location, company.contact_person].join(' ').toLowerCase().includes(search.toLowerCase()),
  )
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Track placement partners and industry supervision contacts."
      />
