...
export function ReportsPage({ stats, placements, logs, evaluations, documents, visits }) {
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Operational summary for coordinators and supervisors."
        action={
      ...
      <section className="panel">
        ...
        <div className="checklist">
          <span>
            <CheckCircle2 size={18} /> Placement records linked to students and companies
          </span>
          <span>
            <CheckCircle2 size={18} /> Weekly logs support review and revision states
          </span>
          <span>
            <CheckCircle2 size={18} /> Evaluations compute overall supervisor scores
          </span>
          <span>
            <CheckCircle2 size={18} /> Exportable operational report available
          </span>
        </div>
      </section>
    </>
