    ...
    <main className="login-page">
      <section className="login-panel auth-panel">
        <div className="login-form">
          ...
          <p className="muted">
            {mode === 'signup'
              ? 'Set up your profile before accessing internship logs and evaluations.'
              ...
              <>
                ...
                <label>
                  ...
                  <select value={form.role} onChange={(event) => update('role', event.target.value)}>
                    ...
                    <option>Industry Supervisor</option>
                  </select>
                </label>
              </>
            )}
        ...
        <aside className="login-photo-panel" aria-label="Students working together">
          <div className="photo-overlay">
            ...
            <h2>Log work, review progress, and evaluate attachment outcomes with clarity.</h2>
          </div>
        </aside>
      </section>
    </main>
